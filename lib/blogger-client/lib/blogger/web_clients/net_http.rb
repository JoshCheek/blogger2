require "net/http"
require 'blogger/response'

# not actually testing this,
# yours might be different anyway
# but this is copy/pasted out of
# one that I wrote, it uses
# basic http auth to authenticate
# with the service
# and then mirrors the rack webclient
module Blogger
  module WebClients
    class NetHttp
